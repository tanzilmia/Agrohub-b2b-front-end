    ...
    <div className="relative w-full  overflow-hidden rounded-lg  shadow-md bg-white ">
      ...
      <div className="mt-4 px-5 pb-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link
            to="#"
            className="flex items-center rounded-md bg-slate-900 px-2 py-1 text-center text-sm font-normal text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"

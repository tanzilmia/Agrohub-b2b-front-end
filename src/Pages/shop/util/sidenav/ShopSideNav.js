      ...
      <div className=" w-80 mb-10 sticky top-16">
        <div className=" my-4  lg:block ">
          <div className="rounded-2xl ">
            ...
            <nav className="mt-6">
              <span className="my-3 font-medium lg:ml-4 ml-3">Category</span>
            ...
            <div className="mt-10">
              <span className="my-3 font-medium lg:ml-4 ml-3">Brand</span>
              <br />
              <select
                onChange={(e) => setSearchValue(e.target.value)}
                data-te-select-init
                className="mt-3 border lg:w-44 w-28 lg:ml-4 ml-3 text-neutral-700 outline-none transition duration-200 ease-in-out focus:z-[3] focus:border-primary focus:text-neutral-700 focus:shadow-[inset_0_0_0_1px_rgb(59,113,202)] focus:outline-none dark:border-neutral-600 dark:text-neutral-500 dark:placeholder:text-neutral-400 dark:focus:border-primary rounded-md"
              >
                {!brands?.length && (

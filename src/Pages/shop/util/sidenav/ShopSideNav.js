...
const ShopSideNav = () => {
  return (
    <div className="sticky top-0">
      <div class="relative hidden h-screen my-4 shadow-lg lg:block ">
        <div class="h-full bg-white rounded-2xl dark:bg-gray-700">
          ...
          <nav class="mt-6">
            <div>
              <a
                class="flex items-center justify-start w-full p-4 pr-0 my-2 font-thin text-blue-500 uppercase transition-colors duration-200 border-r-4 border-blue-500 bg-gradient-to-r from-white to-blue-100 dark:from-gray-700 dark:to-gray-800"
                href="#"
              >
                ...
                <span class="ml-4 text-xs tracking-tighter leading-3 capitalize font-normal">
                  All Products
                </span>
              </a>
              <a
                class="flex items-center justify-start w-full p-4 pr-0 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 dark:text-gray-200 hover:text-blue-500"
                href="#"
              >
                <span class="text-left">
                  <svg
                ...
                <span class="mx-4 text-xs tracking-tighter leading-3 capitalize font-normal">
                  Apparel
                </span>
              </a>
              <a

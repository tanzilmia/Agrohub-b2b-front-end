    ...
    <SwiperSlide className="flex flex-col items-center justify-center w-full max-w-sm mx-auto ">
      ...
      <div className="w-56 -mt-10 overflow-hidden  rounded-lg shadow-lg md:w-64 ">
        <div className="flex items-center justify-between mx-4">
          <h3 className="py-2 font-bold tracking-wide text-center  uppercase dark:text-white">
            {product?.name}
          </h3>
        ...
        <div className="flex items-center justify-between px-3 py-2 bg-gray-200 dark:bg-gray-300">

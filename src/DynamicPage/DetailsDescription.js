            ...
            <div className=''>
                <div className='flex flex-col-reverse md:flex-row items-center gap-20'>
                    <div>
                        ...
                        <p className='my-4'>With a slim design, a vibrant entertainment system, and
                            ...
                            and be inspired.</p>
                        <p className='text-2xl font-semibold'>Draw inspiration with S Pen</p>
                        <p className='my-4'>
                    ...
                    <img src="https://i.ibb.co/WzsXgTZ/product-details-desc-1.jpg" className='md:w-[300px] md:h-[300px] lg:h-full lg:w-full' alt="" />
                </div>
                <div className='md:flex items-center gap-20 mt-20'>
                    <img src="https://i.ibb.co/YpLfmt1/product-details-desc-2.jpg" className='md:w-[300px] md:h-[300px] lg:h-full lg:w-full' alt="" />
                    <div>
                        <p className='text-2xl font-semibold'>Carry with <br />

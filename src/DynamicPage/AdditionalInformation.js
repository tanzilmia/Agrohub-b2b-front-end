...
const AdditionalInformation = () => {
    const [additionalInformation, setAdditionalInformation] = useState({ name: '', feature: '' })
    const datas = [
    ...
    const onSubmit = (event) => {
        ...
        setAdditionalInformation({ name: name, feature: value })
    }
    ...
    return (
        <div>
            ...
            <form onSubmit={onSubmit} className='mx-20 mb-6 md:grid md:grid-cols-2 gap-x-20'>
                <div className="mb-2">
                    <label>

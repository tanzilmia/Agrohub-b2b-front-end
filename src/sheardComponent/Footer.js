...
export default function Footer() {
  // using an array of object to display footer section by mapping
  const footerNavs = [
    {
      label: "Company",
      items: [
  ...
  return (
    <footer className="text-gray-500 bg-white px-4 py-5 max-w-screen-xl mx-auto md:px-8">
      <div className="gap-6 justify-between md:flex">
        {/* footer detail and subscription part */}
        ...
        {/* footer detail and subscription part ends*/}

        {/* footer link display part */}
        <div className="flex-1 mt-10 space-y-6 items-center justify-between sm:flex md:space-y-0 md:mt-0">
          {/* mapping footer footerNavs with multi map*/}
        ...
        {/* footer link display part ends*/}
      </div>

      {/* footer last part */}
      <div className="mt-8 py-6 border-t items-center justify-between sm:flex">
        <div className="mt-4 sm:mt-0">
          &copy; 2022 Agrohub UI All rights reserved.
        </div>

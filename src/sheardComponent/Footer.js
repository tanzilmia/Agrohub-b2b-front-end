/* 
            ...
            @Task: Making a footer components
...
export default function Footer() {
  ...
  return (
    <>
      {showMenu && (
        <div className=" pt-12 bg-white dark:bg-[#242526] lg:px-16 px-5">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex">
                ...
                <Link
                  ...
                  title="Our phone"
                  className="transition-colors duration-300 dark:text-gray-300 text-deep-purple-accent-400 hover:text-deep-purple-800"
                >
                  850-123-5021
                </Link>
              </div>
          ...
          <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
            ...
            <ul className="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row">
              <li>
                <Link
                  to="/"
                  className="text-sm text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-deep-purple-accent-400"
                >
                  F.A.Q
                </Link>
              </li>

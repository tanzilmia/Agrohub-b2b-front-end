...
const HomeDashboard = () => {
  ...
  useEffect(() => {
    axios.get(`http://localhost:5000/payment-gateway/totalsells`)
    .then(res => {
  ...
  <div className="font-bold text-5xl text-center text-[#6c976c] flex justify-center"> <FaUsers/> </div>
    <p className="text-center text-2xl">
